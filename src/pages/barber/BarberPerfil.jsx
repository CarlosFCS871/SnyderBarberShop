      ...
      <main className="px-6 py-6">
        <form onSubmit={handleGuardar} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative w-28 h-28 rounded-full bg-white/10 flex items-center justify-center overflow-hidden border-2 border-accent">
              {perfil.fotoUrl ? (
                <img 
                  src={perfil.fotoUrl} 
                  alt="Perfil" 
            ...
            <p className="text-sm text-gray-400">Esta foto la verán tus clientes</p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <input type="text" name="nombre" required value={perfil.nombre} onChange={handleChange} className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-accent" />
            </div>
            
            <div>
              <label className="block text-sm text-gray-300 mb-1">Apellido</label>
              <input type="text" name="apellido" required value={perfil.apellido} onChange={handleChange} className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-accent" />
            </div>

            <div>
              <label className="block text-sm text-gray-300 mb-1">Teléfono</label>
              <input type="tel" name="telefono" required value={perfil.telefono} onChange={handleChange} className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-accent" />
            </div>
            
            <div>
              <label className="block text-sm text-gray-300 mb-1">Correo Electrónico</label>
              <input type="email" value={perfil.correo || ''} readOnly className="w-full bg-black/20 border border-white/5 rounded-lg px-4 py-3 text-gray-500 cursor-not-allowed" />
            </div>
          </div>
